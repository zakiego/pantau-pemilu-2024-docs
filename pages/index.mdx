...
Project ini berjalan untuk mengumpulkan data Pemilu 2024. Data yang
diambil adalah berasal dari _website_
...
- Data ini boleh digunakan untuk kepentingan apapun, selama tidak melanggar
  hukum.
- Data dari TPS seluruh Indonesia belum masuk ke _website_ KPU 100% sehingga data yang
  diambil juga belum lengkap.
- Data pada database ini akan diperbaharui mengikuti perkembangan data
  pada _website_ KPU.
...
> Catatan
>
> - Data dalam database akan terus kami _update_ seiring dengan perkembangan data _website_ KPU.
>   Sedangkan file yang diunggah ke Google
>   Drive belum bisa di-_update_ secara otomatis. Jadi, untuk mendapatkan data
>   terkini, disarankan menggunakan database secara langsung.
>
...
>
> - Selama proses _development_, _schema_ pada database ini bisa berubah sewaktu-waktu. Jadi,
>   pastikan selalu periksa dokumentasi ini.
...
Selain itu, data pada project ini dapat bisa diakses melalui API. Namun, baru terdapat satu
_endpoint_ yang bisa diakses serta hanya berupa data TPS untuk Pemilihan Presiden dan
Wakil Presiden.
...
Pastikan untuk menggunakan parameter `limit` karena jika tidak digunakan,
...
mendapatkan data yang paling terkini, disarankan untuk menggunakan database secara
langsung
