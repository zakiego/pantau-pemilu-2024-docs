...
Berikut adalah waktu terakhir data discrape dari website KPU. Data diperbaharui
secara otomatis setiap hari menggunakan
[GitHub Actions](https://github.com/zakiego/pantau-pemilu-2024/actions/). Setiap
baris data mungkin saja diperbaharui pada waktu yang berbeda, karena beberapa
hal saat proses _scraping_.
